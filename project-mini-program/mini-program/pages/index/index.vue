<template>
	<view class="container">
		<view class="banner">
			<image src="https://mp-13a86627-9a4d-45d3-a214-e84c157a7c27.cdn.bspapp.com/index/bg.png" mode="" class="bg"></image>
			<view class="intro">
				<view class="greet">您好，{{ isLogin ? member_info.nickname : '游客' }}</view>
			</view>
		</view>
		<view class="content">
			<view class="entrance">
			...
			<view class="info">
				<view class="integral_section" @tap="integrals">
					<view class="top">
						...
						<text class="value">{{ isLogin ? member_info.pointNum : '***' }}</text>
					</view>
					<view class="bottom">
						进入积分商城兑换美食券（暂未开发）
				...
				<view class="right">
					<view class="tea-activity" @tap="invite">
						...
						<view class="right-img">
							<image src="/static/images/index/mcsb_https://mp-13a86627-9a4d-45d3-a214-e84c157a7c27.cdn.bspapp.com/index/bg.png" mode="widthFix"></image>
						</view>
					</view>
					<view class="member-gifts" @tap="packages">
						...
						<view>会员劵包</view>
						<view class="right-img">
							<image src="/static/images/index/hyjb_https://mp-13a86627-9a4d-45d3-a214-e84c157a7c27.cdn.bspapp.com/index/bg.png" mode="widthFix"></image>
						</view>
					</view>
				</view>
			</view> -->
			<view class="member-news">
				...
				<view class="list">
					<view class="item">
						<image src="https://mp-13a86627-9a4d-45d3-a214-e84c157a7c27.cdn.bspapp.com/index/news.png"></image>
					</view>
				</view>
			</view>
		</view>
