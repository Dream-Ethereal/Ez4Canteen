			...
			<view class="user-box">
				...
				<view class="w-100 d-flex font-size-sm text-color-assist mb-30">
					<!-- <view class="user-grid" @tap="coupons">
						<view class="value">{{ member_info.couponNum }}</view>
						<view>奈雪券</view>
					</view> -->
					<view class="user-grid" @tap="integrals">
						<view class="value">{{ member_info.pointNum }}</view>
						<view>积分</view>
					</view>
					<view class="user-grid" @tap="balance">
						<view class="value">{{ member_info.balance }}</view>
						<view>余额</view>
					</view>
					<!-- <view class="user-grid">
						<view class="value">{{ member_info.giftBalance }}</view>
						<view>礼品卡</view>
					</view> -->
				</view>
				<!-- user grids end -->
