	...
	<view class="container">
		...
		<view style="padding: 0 30rpx;">
			...
			<view class="d-flex flex-column bg-white user-box">
						...
						<view class="d-flex align-items-center">
							<view class="avatar">
								<image :src="isLogin ? member_info.avatar : '/static/images/mine/default.png'"></image>
								<view class="badge" v-if="isLogin">
									<image src="/static/images/mine/level.png"></image>
									<view>{{ member_info.memberLevel }}</view>
								</view>
							</view>
							<view class="d-flex flex-column flex-fill overflow-hidden" style="margin-top: 20rpx;">
								<view v-if="isLogin" class="font-size-lg font-weight-bold d-flex justify-content-start align-items-center"
									@tap="userinfo">
									<view class="text-truncate">{{ member_info.nickname }}</view>
								...
								<view class="font-size-sm text-color-assist">
									当前成长值{{ isLogin ? member_info.pointNum : 0 }}/{{ isLogin ? member_info.needValue : 0 }}
								</view>
								<view class="w-100">
		...
		<view class="service-box">
			...
			<view class="row">
				...
				<view class="grid" @tap="shop">
					<view class="image">
						<image src="/static/images/mine/nxsc.png"></image>
					</view>
					<view>积分商城</view>
				</view>
				<view class="grid" @click="makePhoneCall">
					<view class="image">
	...
	export default {
		...
		computed: {
			...
			growthValue() {
				...
				const {pointNum, needValue} = Member
				return pointNum / (pointNum + needValue) * 100
			}
		},
		onLoad() {
